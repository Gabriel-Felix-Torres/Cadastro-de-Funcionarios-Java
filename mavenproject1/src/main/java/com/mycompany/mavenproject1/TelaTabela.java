...
public class TelaTabela extends javax.swing.JFrame {
    public void adicionarDados(String nome, int idade, String sexo, int cpf, String cargo) {
    DefaultTableModel model = (DefaultTableModel) tbFuncionarios.getModel();
    model.addRow(new Object[]{nome, idade, sexo, cpf, cargo});
}
